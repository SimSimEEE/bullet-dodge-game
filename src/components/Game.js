...
class Game extends Component {
    ...
    updateGame = () => {
        ...
        bombs.forEach((bomb) => {
            ...
            if (
                bomb.xPos < 0 ||
                bomb.xPos > canvasWidth + bomb.size + 55 ||
                bomb.yPos < 0 ||
                bomb.yPos > canvasHeight + bomb.size + 55
            ) {
                bomb.xPos = randomItemInArray([0, canvasWidth + 55]);
                bomb.yPos = randomItemInArray([0, canvasHeight + 55]);
