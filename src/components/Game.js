...
class Game extends Component {
    ...
    updateGame = () => {
        ...
        bombs.forEach((bomb) => {
            ...
            if (
                bomb.xPos < 0 ||
                bomb.xPos > canvasWidth + bomb.size + 110 ||
                bomb.yPos < 0 ||
                bomb.yPos > canvasHeight + bomb.size + 110
            ) {
                bomb.xPos = randomItemInArray([0, canvasWidth + 110]);
                bomb.yPos = randomItemInArray([0, canvasHeight + 110]);
